...
serve(async (req) => {
  ...
  try {
    ...
    // STEP 5: Check credits with detailed validation
    let profile;
    try {
    ...
    // STEP 6: Perform analysis with timeout protection
    ...
    // STEP 7: Save to database with transaction safety
    ...
    // STEP 8: Consume credit with rollback on failure
    ...
    // STEP 9: Return success with comprehensive data
    console.log("=== ANALYSIS COMPLETED SUCCESSFULLY ===");
